...
# caviar_union <- read.table("R_caviar_t=2_c=3_union_config_size.txt", header = F)
# caviar_intersect <- read.table("R_caviar_t=2_c=3_intersect_config_size.txt", header = F)
# mscaviar <- read.table("R_mscaviar_t=2_c=3_config_size.txt", header = F)
# paintor <- read.table("R_paintor_t=2_c=3_config_size.txt", header = F)
# plotName <- "t=2_c=3_config_size.png"
# tau <- 0
# causal <- 1
